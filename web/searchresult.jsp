...
<div class="search-area-wrapper">
    <div class="search-area container">
        <h3 class="search-header">查企业就用企业像</h3>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="span8 main-listing">
                <s:iterator value="#list" id="company1">
                    <article class="format-standard type-post hentry clearfix">
                        <header class="clearfix">
                            <h3 class="post-title" name="name">
                                <a href="detail.action?companyname=<s:property value="#company1.cname"/>">
                                    <s:property value="#company1.cname" />
                                </a>
                            </h3>
                        </header>
                    </article>
